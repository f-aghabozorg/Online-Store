...
namespace Online_Store.Application.Services.Carts
{
    ...
    public class CartService : ICartService
    {
        ...
        public ResultDto<CartDto> GetMyCart(Guid BrowserId, long? UserId)
        {
            try
            {
                ...
                //var prod_id = query_obj.CartItems.Select(p => p.ProductId).FirstOrDefault();
                //var prod = _context.Products.Where(p => p.Id == prod_id).FirstOrDefault();
                ...
                //if (prod_price !=cart.CartItems.Select(p => p.Price).FirstOrDefault())
                //{
                //    //cart.CartItems= prod_price;
                //}
