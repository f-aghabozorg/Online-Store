...
namespace EndPoint.Site.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public IActionResult Signup(SignupViewModel request)
        {
            ...
            {
                return Json(new ResultDto { IsSuccess = false, Message = "لطفا تمامی موارد را تکمیل و ارسال نمایید" });
            }
                ...
                var claims = new List<Claim>()
            {
                ...
                //new Claim(ClaimTypes.StreetAddress, request.),
                //new Claim(ClaimTypes.LastName, request.LastName),
