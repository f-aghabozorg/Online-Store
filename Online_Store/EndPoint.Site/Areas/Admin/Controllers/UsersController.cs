...
namespace EndPoint.Site.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult Index(string serchkey, int page = 1)
       {
        ...
        [HttpPost]
        public IActionResult Create(string Email, string FirstName,string LastName, long RoleId, string Password, string RePassword)
        {
        ...
        [HttpPost]
        public IActionResult Edit(long UserId, string FirstName,string LastName)
        {
